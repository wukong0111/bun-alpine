...
export async function verifySessionToken(
	token: string,
	jwt: { verify: (token: string) => Promise<object> },
...
export function getAuthenticatedUser(context: { cookie?: { auth_token?: string }; user?: SessionData }): AuthContext {
...
export function requireAuth(context: { cookie?: { auth_token?: string }; user?: SessionData }) {
	...
	return auth.user as SessionData;
}
